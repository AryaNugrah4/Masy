...
class ComplaintEditScreen extends StatefulWidget {
  ...
  const ComplaintEditScreen({Key? key, required this.complaint}) : super(key: key);
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _isImageUploaded == false && complaint['image'].toString().isNotEmpty
                      ? Column(
                          children: [
                            Align(
              ...
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(HexColor('#FF6C6C')),
                    ),
                    child: Text(
                      "Cancel",
                      style: whiteOnBtn,
