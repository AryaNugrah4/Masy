...
import 'package:masy/admin/screen/complaint_list/complaint_respond.dart';
...
class _ComplaintDetailScreenState extends State<ComplaintDetailScreen> {
  ...
  userComplaint() async {
    ...
    var checkUsers = await FirebaseFirestore.instance.collection('users').doc(complaint['idUser']).get();
